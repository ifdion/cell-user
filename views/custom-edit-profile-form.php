...
<form id="edit-profile" name="edit-profile" class="well form-horizontal" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" enctype="multipart/form-data">
	<fieldset id="billing-field">
		...
		<div class="control-group">
			<label class="control-label" for="first-name"><?php _e('First Name', 'cell-user') ?></label>
			<div class="controls">
				<input type="text" class="input-xlarge " id="first-name" name="first-name" value="<?php echo $first_name ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="last-name"><?php _e('Last Name', 'cell-user') ?></label>
			<div class="controls">
				<input type="text" class="input-xlarge " id="last-name" name="last-name" value="<?php echo $user_data['last_name'][0] ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="email"><?php _e('Email', 'cell-user') ?></label>
			<div class="controls">
				<input type="text" class="input-xlarge " id="email" name="email" value="<?php echo $current_user->user_email ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="password1"><?php _e('Password', 'cell-user') ?></label>
			<div class="controls">
				<input type="password" class="input-xlarge " id="password1" name="password1" >
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="password2"><?php _e('Retype Password', 'cell-user') ?></label>
			<div class="controls">
				...
				<?php if (isset($selected_country) || !$current_shipping_country): ?>
					<select id="country" name="country" class="select-address" data-target="province">
						<?php if ( $countries->have_posts() ) : ?>
							...
							<?php endwhile; ?>
							<option value="other"><?php _e('Other', 'cell-user') ?></option>
						<?php endif; ?>
					</select>
				<?php else: ?>
		...
		<div class="control-group">
			<label class="control-label" for="shipping-province"><?php _e('Province / State / County', 'cell-user') ?></label>
			<div class="controls">
				<?php
				...
				<?php if (isset($selected_province) || !$current_shipping_province): ?>
					<select id="province" name="province" <?php echo $disabled; ?> class="select-address" data-target="city">
						<option value="intro"><?php _e('Please select - leave empty if not applicalble', 'cell-user') ?></option>
		...
		<div class="control-group">
			<label class="control-label" for="city"><?php _e('City', 'cell-user') ?></label>
			<div class="controls">
				<?php
		...
		<div class="control-group">
			<label class="control-label" for="district"><?php _e('District', 'cell-user') ?></label>
			<div class="controls">
				<?php
		...
		<div class="control-group">
			<div class="controls">
				<label class="control-label" for="have-shipping">
					...
					<?php _e('Use another shipping address', 'cell-user') ?>
				</label>
			</div>
		</div>	
	</fieldset>
	<fieldset id="shipping-field">
		...
		<div class="control-group">
			<label class="control-label" for="shipping-first-name"><?php _e('First Name', 'cell-user') ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="shipping-last-name"><?php _e('Last Name', 'cell-user') ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="shipping-email"><?php _e('Email', 'cell-user') ?></label>
			<div class="controls">
				<input type="text" class="input-xlarge " id="shipping-email" name="shipping-email" value="<?php echo $user_data['shipping-email'][0] ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="shipping-telephone"><?php _e('Telephone', 'cell-user') ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="shipping-country"><?php _e('Country', 'cell-user') ?></label>
			<div class="controls">
				<?php
					$args = array(
						'post_type' => 'shipping-destination',
		...
		<div class="control-group">
			<label class="control-label" for="shipping-city"><?php _e('City', 'cell-user') ?></label>
			<div class="controls">
				<?php
		...
		<div class="control-group">
			<label class="control-label" for="shipping-district"><?php _e('District', 'cell-user') ?></label>
			<div class="controls">
				<?php
