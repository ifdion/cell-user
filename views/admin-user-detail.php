		...
		<table class="form-table">
			...
			<tr>
				...
				<th><label for="country"><?php _e('Country', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="province"><?php _e('State / Province', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="city"><?php _e('City', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="district"><?php _e('District', 'cell-user') ?></label></th>
				<td>
		...
		<h3 id="shipping"><?php _e('Shipping Address', 'cell-user') ?></h3>
		<table class="form-table">
			<tr>
				<th><label for="shipping-first-name"><?php _e('Name', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				<th><label for="shipping-telephone"><?php _e('Telephone Number', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				<th><label for="shipping-company"><?php _e('Company', 'cell-user') ?></label></th>
				<td>
				<input type="text" id="shipping-company" name="shipping-company" value="<?php echo get_user_meta($user->ID, 'shipping-company', true) ?>">
				</td>
			</tr>
			<tr>
				<th><label for="shipping-address"><?php _e('Address', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				<th><label for="shipping-postcode"><?php _e('Postcode', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="shipping-country"><?php _e('Country', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="shipping-province"><?php _e('State / Province', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="shipping-city"><?php _e('City', 'cell-user') ?></label></th>
				<td>
			...
			<tr>
				...
				<th><label for="shipping-district"><?php _e('District', 'cell-user') ?></label></th>
				<td>
